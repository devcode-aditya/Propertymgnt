table 115 "Sales Cr.Memo Line"
{
    ...
    keys
    {
        ...
        key(Key7;"No.","Sell-to Customer No.")
        {
        }
        key(Key8;"Sell-to Customer No.","Element Type","Rental Element","Agreement Posting Date")
        {
    ...
    var
        ...
        SalCrMemoHdr: Record "114";
    begin
        //APNT-T009914
        CLEAR(SalCrMemoHdr);
        IF SalCrMemoHdr.GET("Document No.") THEN;
        TESTFIELD(Barcode);
        TESTFIELD("Line No.");
        ...
        DocumentBin.SETRANGE("Document No.",SalCrMemoHdr."Pre-Assigned No.");
