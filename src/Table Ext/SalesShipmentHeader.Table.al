table 110 "Sales Shipment Header"
{
    ...
    fields
    {
        ...
        field(50211;"House Type";Option)
        {
            Description = 'APNT-HRU1.0';
            OptionCaption = ' ,Villa,Apartment/Office ';
            OptionMembers = " ",Villa,"Apartment/Office ";
        }
    ...
    keys
    {
        ...
        key(Key6;"Reciving/Picking No.")
        {
        }
        key(Key7;"Statement No.")
        {
        }
        key(Key8;"VAN Sales Order","Push to VAN")
        {
        }
    }
