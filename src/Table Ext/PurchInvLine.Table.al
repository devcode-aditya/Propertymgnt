table 123 "Purch. Inv. Line"
{
    ...
    DrillDownFormID = Form529;
    LookupFormID = Form529;
    ...
    keys
    {
        key(Key1;"Document No.","Line No.")
        {
            ...
            SumIndexFields = Amount,"Amount Including VAT","Line Discount Amount";
        }
    ...
    procedure CalcReceivedPurchNotReturned(var RemainingQty: Decimal;var RevUnitCostLCY: Decimal;ExactCostReverse: Boolean): Decimal
    var
    ...
    begin
        IF Type = Type::Item THEN BEGIN
          ...
          FORM.RUNMODAL(0,TempPurchRcptLine);
        END;
    end;
    ...
    var
        ...
        PurchInvHder: Record "122";
    begin
        //APNT-T009914
        CLEAR(PurchInvHder);
        IF PurchInvHder.GET("Document No.") THEN;

        TESTFIELD(Barcode);
        TESTFIELD("Line No.");
        DocumentBin.SETRANGE(Type,DocumentBin.Type::GRN);
        DocumentBin.SETRANGE("Document Type",DocumentBin."Document Type"::Order);
        DocumentBin.SETRANGE("Document No.",PurchInvHder."Order No.");
